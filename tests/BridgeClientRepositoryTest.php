...
use Masdevs\Passenger\Bridge\ClientRepository;
...
class BridgeClientRepositoryTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_can_get_client_for_auth_code_grant()
    {
        ...
        $this->assertInstanceOf('Masdevs\Passenger\Bridge\Client', $client);
    ...
    public function test_can_get_client_for_client_credentials_grant()
    {
        ...
        $this->assertInstanceOf('Masdevs\Passenger\Bridge\Client', $repository->getClientEntity(1, 'client_credentials', 'secret', true));
