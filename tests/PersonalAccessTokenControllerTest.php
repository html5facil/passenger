...
class PersonalAccessTokenControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_tokens_can_be_retrieved_for_users()
    {
        ...
        $controller = new Masdevs\Passenger\Http\Controllers\PersonalAccessTokenController($validator);
    ...
    public function test_tokens_can_be_updated()
    {
        ...
        $controller = new Masdevs\Passenger\Http\Controllers\PersonalAccessTokenController(
            $validator
        );
