...
use Masdevs\Passport\Guards\TokenGuard;
...
class PassportServiceProvider extends ServiceProvider
{
    ...
    {
        $this->loadViewsFrom(__DIR__.'/../resources/views', 'passenger');

        if ($this->app->runningInConsole()) {
            $this->registerMigrations();

            $this->publishes([
                __DIR__.'/../resources/views' => base_path('resources/views/vendor/passenger'),
            ], 'Passport-views');

            $this->publishes([
                __DIR__.'/../resources/assets/js/components' => base_path('resources/assets/js/components/passenger'),
            ], 'passport-components');
